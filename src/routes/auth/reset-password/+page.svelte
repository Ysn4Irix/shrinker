...
<svelte:head>
	<title>Shrinker | Reset Password</title>
</svelte:head>

<Auth template="reset-password" title="Reset Password" data="">
	{#if form?.success}
		<div
			id="dismiss-alert"
				...
				<div class="ml-4">
					...
					<div class="mt-2 text-sm text-green-700">
						<ul class="list-disc space-y-1 pl-5">
							<li>An email has been sent to reset your password!, please check your inbox.</li>
						</ul>
					</div>
				</div>
	...
	{/if}
	<!-- Form -->
	<form action="?/resetPassword" method="POST" use:enhance={submitResetPassword}>
